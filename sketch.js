...
function setup() {
  ...
  spaceship.scale = 0.3
  spaceship.setCollider('rectangle', 0, 0, 200, 450 )
...
function draw() {
  ...
  if (gameState==='serve'){
    ...
    text('Space Warrior', displayWidth/2 - 200, displayHeight/2 - 150)
    textSize(35)
    text('Press P to play', displayWidth/2 - 150, displayHeight/2 - 50)
    text('Instructions:', displayWidth/2 - 150, displayHeight/2 + 150)
    text('Use WASD to move around\nUse Space to shoot upwards\nUse Down Arrow to shoot downwards', displayWidth/2 - 200, displayHeight/2 + 200)
    if (keyDown('p')){
      gameState = 'play'
    }
  }
...
if (gameState==='end'){
  ...
  textSize(45)
  text('Press R to restart', displayWidth/2 - 180, displayHeight / 2 + 100)
